...
public class MainActivity extends AppCompatActivity {
    ...
    private void setDataToAdapter() {
        articleAdapter articleAdapter = new articleAdapter(arrayList,MainActivity.this);
